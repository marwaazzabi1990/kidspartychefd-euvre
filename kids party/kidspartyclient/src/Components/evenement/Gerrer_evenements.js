...
import { Icon, Label, Menu, Table, Pagination, Button } from 'semantic-ui-react'
...
class GererEvent extends Component {
    ...
    render() {
        ...
        const events = event.filter(el => this.props.authetification && el.nom_organzateur === this.props.authetification.nom)
            ...
            < div >
                ...
                >
                    {this.props.authetification ?
                        ...
                        <ModalAddevent nom={this.props.authetification.nom} /> : null}
                </button>
                        ...
                        {events/*.filter((el_organizateurs) => this.el_organizateurs === "" ?
                            ...
                            .map((el, i) => (<Table.Row>
                                ...
                                <Table.Cell className="pos-Action ">
                                    <Button secondary><ModifEvent el={el} /></Button>
                                    <Button outline size="sm" onClick={() => this.props.deleteEvent(el._id)}><i class="fas fa-trash"></i></Button></Table.Cell>
                            </Table.Row>
