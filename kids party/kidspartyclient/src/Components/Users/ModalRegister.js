    ...
    handelChange = (e) => {
        ...
        if (e.target.name === "password") {
            ...
            if (this.state.password.length < 7) {
                this.setState({ passworError: 'password must be more 7', passetat: "false" });
                            ...
                            <Row form>
                                <Col md={6}>
                                    <FormGroup>
                                        ...
                                        <Input type="text" required name="nom" id="nom" placeholder=" nom" onChange={(e) => this.setState({ nom: e.target.value })} />
                                ...
                                <Col md={6}>
                                    <FormGroup>
                                        ...
                                        <Input type="text" required name="prenom" id="prenom" placeholder="prenom" onChange={(e) => this.setState({ prenom: e.target.value })} />
                                    </FormGroup>
                                </Col>
                                <Col md={6}>
                                    <FormGroup>
                                        <Label for="exampleEmail">Établissement</Label>
                                        <Input type="text" requiredname="établissement" id="établissement" placeholder="nom d'établissement" onChange={(e) => this.setState({ établissement: e.target.value })} />
                                    </FormGroup>
                                </Col>
                                ...
                                <Col md={6}>
                                    <FormGroup>
                                        ...
                                        <Input type="file" name="photos" id="photos" onChange={this.fileSelectedHandler} />
                                ...
                                <Col md={6}>
                                    <FormGroup>
                                        ...
                                        <Input type="text" required name="email" id="email" placeholder="email" onChange={this.handelChange} />
                                        {this.state.EmailError ? (<span span style={{ fontSize: 12, color: "red" }}>{this.state.EmailError}</span>) : null}
                                    </FormGroup>
                                </Col>
                                <Col md={6}>
                                    <FormGroup>
                                        <Label for="exampleEmail">Username</Label>
                                        <Input type="text" required name="username" id="username" placeholder="username" onChange={this.handelChange} />
                                ...
                                <Col md={6}>
                                    <FormGroup>
                                        ...
                                        <Input type="password" required name="password" id="examplePassword" placeholder="password placeholder" onChange={this.handelChange} />
                                        {this.state.passworError ? (<span span style={{ fontSize: 12, color: "red" }}>{this.state.passworError}</span>) : null}
                                    </FormGroup>
                                </Col>
                            </Row>
                            <FormGroup>
                                <Label for="exampleAddress">Address</Label>
                                <Input type="text" name="address" required id="exampleAddress" onChange={(e) => this.setState({ address: e.target.value })} />
                            </FormGroup>
