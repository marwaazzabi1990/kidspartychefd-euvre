...
export function getUsersFromApi() {
    return (dispatch) =>
        Axios.get("http://localhost:8080/user/getallusers").then(
            (res) => {
...
export function addUserFromApi(element) {
    ...
    return (dispatch) =>
        Axios.post(`http://localhost:8080/user/adduser`, element).then(
            (res) => {
...
export function deleteUserToApi(id) {
    return (dispatch) =>
        Axios.delete(`http://localhost:8080/user/deletuser/${id}`).then(
            (res) => {
